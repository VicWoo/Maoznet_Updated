...
{
    public class Clique : IEnumerable<int>, IComparable
    {
        ...
        public Clique(List<int> members, int n)
        {
            _members = new List<int>(members);
        ...
        {
            Clique c = obj as Clique;
            if (c == null)
                throw new CliqueException("Cannot compare to null Clique or non-Clique object.");
